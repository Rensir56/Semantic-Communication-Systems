          ...
          <div class="left-panel">
            ...
            <div class="image-box">
                ...
                <div class="image-preview" v-else>
                    ...
                    <div class="add-more" @click.stop="triggerUpload" v-if="selectedImages.length < 16">
                    <i class="el-icon-plus"></i>
                    <p>添加更多</p>
                    </div>
                </div>
            ...
            <div class="button-group">
              <el-button type="primary" @click="sendImages" :disabled="!selectedImages.length">
                发送图片
              </el-button>
              <el-button type="success" @click="evaluate" :disabled="!hasReceivedImages">
                评估结果
              </el-button>
            </div>
          </div>
        ...
        <el-col :span="12">
          <div class="right-panel">
            ...
            <div class="image-box">
              ...
              <div class="image-preview" v-else>
                <div v-for="(img, index) in reconstructedImages" :key="index" class="preview-item">
            ...
            <div class="image-box" v-if="uapEnabled">
              ...
              <div class="image-preview" v-else>
                <div v-for="(img, index) in uapImages" :key="index" class="preview-item">
